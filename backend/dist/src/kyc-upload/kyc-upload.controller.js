...
exports.KycUploadController = void 0;
const common_1 = require("@nestjs/common");
const platform_express_1 = require("@nestjs/platform-express");
const kyc_upload_service_1 = require("./kyc-upload.service");
let KycUploadController = class KycUploadController {
    kycUploadService;
    constructor(kycUploadService) {
    ...
    getKycHtmlTemplate(token, customerName, customerPhone, isSubmitted, status) {
...
exports.KycUploadController = KycUploadController;
__decorate([
    (0, common_1.Post)('generate-link/:leadId'),
    __param(0, (0, common_1.Param)('leadId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], KycUploadController.prototype, "generateLink", null);
__decorate([
    (0, common_1.Get)('documents/:leadId'),
    __param(0, (0, common_1.Param)('leadId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], KycUploadController.prototype, "getDocuments", null);
__decorate([
    (0, common_1.Get)('form/:token'),
    (0, common_1.Header)('Content-Type', 'text/html'),
    __param(0, (0, common_1.Param)('token')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], KycUploadController.prototype, "getForm", null);
__decorate([
    (0, common_1.Post)('submit/:token'),
    ...
    __metadata("design:returntype", Promise)
], KycUploadController.prototype, "submitKyc", null);
exports.KycUploadController = KycUploadController = __decorate([
    (0, common_1.Controller)('kyc-upload'),
    __metadata("design:paramtypes", [kyc_upload_service_1.KycUploadService])
], KycUploadController);
//# sourceMappingURL=kyc-upload.controller.js.map