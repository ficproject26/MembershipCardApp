...
class StaffProfileSettingsTab extends StatefulWidget {
  const StaffProfileSettingsTab({super.key});
      ...
      child: Row(
        ...
        children: [
          ...
          Switch(
            value: value,
            onChanged: onChanged,
            activeThumbColor: useBlueThumb ? Colors.blue[300] : accentColor,
            activeTrackColor: useBlueThumb ? Colors.blue.withValues(alpha: 0.3) : accentColor.withValues(alpha: 0.3),
