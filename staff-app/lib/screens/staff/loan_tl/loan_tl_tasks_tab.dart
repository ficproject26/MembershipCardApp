...
class LoanTlTasksTab extends StatefulWidget {
  const LoanTlTasksTab({super.key});
                              ...
                              cells: [
                                ...
                                DataCell(
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: statusStr == 'Pending' ? Colors.orange.withValues(alpha: 0.1) : Colors.cyan.withValues(alpha: 0.1),
                                      borderRadius: BorderRadius.circular(12),
                                      border: Border.all(color: statusStr == 'Pending' ? Colors.orange.withValues(alpha: 0.3) : Colors.cyan.withValues(alpha: 0.3)),
                                    ),
                                    child: Row(
